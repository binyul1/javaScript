...
export default function SingleProductDetail({
  ...
  return (
    <>
      <section className="py-8 bg-white md:py-16  antialiased">
        <div className="max-w-7xl px-4 mx-auto 2xl:px-0">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            ...
            <div className="mt-6 sm:mt-8 lg:mt-0 flex flex-col gap-3">
              ...
              <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
                ...
                <div className="flex items-center gap-2 mt-2 sm:mt-0">
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 5].map((rate) => (
                      <svg
                        className={`size-4 ${Math.floor(product.rating) >= rate ? "text-yellow-300" : "text-gray-200"}`}
                        aria-hidden="true"
              ...
              <div className="flex items-center gap-2 mt-2 sm:mt-2 text-gray-500 ">
                category: {product.category}, brand: {product.brand}, stock: {product.stock}
              </div>
      ...
      {/*Review*/}
      <section className="py-8 bg-white md:py-16  antialiased">
      <div className="mt-6 divide-y divide-gray-200 shadow p-5">
