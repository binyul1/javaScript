...
class ProductController {
  ...
  async updateProduct(req: Request, res: Response, next: NextFunction) {
    try{
      ...
      const update = await ProductService.updateSingleRowByFilter({slug: slug}, mappedData);
      res.json({
        data: update,
  ...
  async deleteProductById(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const deletedStatus = await ProductService.deleteSingleRowByFilter({ _id: productId });
