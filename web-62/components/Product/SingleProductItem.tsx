      ...
      <div className="pt-6">
        ...
        <div className="mt-2 flex items-center gap-2">
          <div className="flex items-center">
            {[1, 2, 3, 4, 5].map((rate: number, i: number) => (
              <svg
                key={rate}
                className={`h-4 w-4 ${
                  rate <= Math.floor(detail?.rating || 0)
                    ? "text-yellow-400"
                    : "text-gray-300"
                }`}
                aria-hidden="true"
          ...
          <p className="text-sm font-medium text-gray-900">
            {Math.floor(detail?.rating || 0).toFixed(1)}
          </p>
        ...
        <div className="mt-4 flex flex-col  gap-4">
          <div className="flex items-center gap-2">
            <p className="text-2xl font-extrabold leading-tight text-gray-900">
              {new Intl.NumberFormat("en-US", {
                ...
                detail?.price * (1 - (detail?.discountPercentage || 0) / 100),
              )}
            </p>
          ...
          <button
            type="button"
            className="inline-flex justify-center items-center rounded-lg bg-teal-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-teal-800 focus:outline-none focus:ring-4 focus:ring-teal-300"
          >
